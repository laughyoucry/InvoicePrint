...
public class BuyCompanyView extends javax.swing.JPanel {

    public static final String INDEX_NAME = ConfigUtils.INDEX_NAME[1];

    public static final String[] COL_NAMES = { "序号", "购方单位名称", "购方税号", "购方地址电话", "购方银行账号" };
    ...
    private void initComponents() {
        ...
        model.addTableModelListener(new TableModelListener() {
            public void tableChanged(TableModelEvent e) {
                ...
                ConfigUtils.buyCompanies.put((Integer) index, com);
            }
        });
        ...
        newBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                data.add(index);
                model.addRow(data);
                ConfigUtils.buyCompanies.put(index, new Company(index));
            }
        });
        ...
        delBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                for (int i = rows.length - 1; i >= 0; i--) {
                    ...
                    ConfigUtils.buyCompanies.remove(index);
                }
            }
        });
